...
class ChannelManaging extends ConsumerWidget {
  const ChannelManaging({super.key, this.onChannelSelected});
    ...
    return PushableListView(
      initializeFuture: () async {
        final response = await ref
            ...
            .channels
            .owned(const ChannelsOwnedRequest());
      ...
      nextFuture: (lastItem, _) async {
        final response = await ref
            .read(misskeyPostContextProvider)
            .channels
            .owned(ChannelsOwnedRequest(untilId: lastItem.id));
        return response.toList();
      },
