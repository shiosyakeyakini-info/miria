...
final class UserInfoNotifierProxyProvider
    extends $FunctionalProvider<Raw<UserInfoNotifier>, Raw<UserInfoNotifier>>
  ...
  Override overrideWithValue(Raw<UserInfoNotifier> value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<Raw<UserInfoNotifier>>(value),
    );
  }
...
final class UserInfoProxyProvider
    extends $FunctionalProvider<AsyncValue<UserInfo>, AsyncValue<UserInfo>>
  ...
  Override overrideWithValue(AsyncValue<UserInfo> value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<AsyncValue<UserInfo>>(value),
    );
  }
...
abstract class _$UserInfoNotifier extends $AsyncNotifier<UserInfo> {
  ...
  void runBuild() {
    ...
    final ref = this.ref as $Ref<AsyncValue<UserInfo>>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<AsyncValue<UserInfo>>,
              AsyncValue<UserInfo>,
              Object?,
              Object?
            >;
