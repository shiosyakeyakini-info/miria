          ...
          child: Column(
            ...
            children: [
              ...
              if (!isOwned)
                Row(
                  children: [
                    ...
                    Expanded(child: Text(S.of(context).muting)),
                  ],
                ),
              if (isOwned) ...[
                ElevatedButton(
                  onPressed: update.executeOrNull,
                  child: Text(S.of(context).chatUpdate),
                ),
              ...
              ExpansionTile(
                ...
                title: Text(S.of(context).chatCreator),
              ...
              ExpansionTile(
                ...
                title: Row(
                  children: [
                    Expanded(child: Text(S.of(context).members)),
                    IconButton(
              ...
              if (isOwned)
                ExpansionTile(
                  initiallyExpanded: true,
                  title: Text(S.of(context).chatInvitation),
                  children: [
                    PushableListView(
                      initializeFuture: () async => [
                        ...await ref
              ...
              if (!isOwned)
                OutlinedButton(
                  ...
                  child: Text(S.of(context).chatLeave),
                ),
            ],
          ),
        ),
