...
final class _InitialSettingsProvider
    extends $FunctionalProvider<AntennaSettings, AntennaSettings>
  ...
  Override overrideWithValue(AntennaSettings value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<AntennaSettings>(value),
    );
  }
}
...
final class _AntennaSettingsNotifierProvider
  ...
  @$internal
  @override
  $NotifierProviderElement<_AntennaSettingsNotifier, AntennaSettings>
...
abstract class _$AntennaSettingsNotifier extends $Notifier<AntennaSettings> {
  ...
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<AntennaSettings>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<AntennaSettings>,
              AntennaSettings,
              Object?,
              Object?
            >;
