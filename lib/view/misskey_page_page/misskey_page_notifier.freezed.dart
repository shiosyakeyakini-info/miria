...
mixin _$MisskeyPageNotifierState {
  ...
  $MisskeyPageNotifierStateCopyWith<MisskeyPageNotifierState> get copyWith =>
      _$MisskeyPageNotifierStateCopyWithImpl<MisskeyPageNotifierState>(
          this as MisskeyPageNotifierState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MisskeyPageNotifierState &&
...
abstract mixin class $MisskeyPageNotifierStateCopyWith<$Res> {
  factory $MisskeyPageNotifierStateCopyWith(MisskeyPageNotifierState value,
          $Res Function(MisskeyPageNotifierState) _then) =
      _$MisskeyPageNotifierStateCopyWithImpl;
  @useResult
...
class _MisskeyPageNotifierState implements MisskeyPageNotifierState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MisskeyPageNotifierStateCopyWith<_MisskeyPageNotifierState> get copyWith =>
      __$MisskeyPageNotifierStateCopyWithImpl<_MisskeyPageNotifierState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MisskeyPageNotifierState &&
            (identical(other.page, page) || other.page == page) &&
            (identical(other.likeOr, likeOr) || other.likeOr == likeOr));
  }
...
/// @nodoc
abstract mixin class _$MisskeyPageNotifierStateCopyWith<$Res>
    implements $MisskeyPageNotifierStateCopyWith<$Res> {
  factory _$MisskeyPageNotifierStateCopyWith(_MisskeyPageNotifierState value,
          $Res Function(_MisskeyPageNotifierState) _then) =
      __$MisskeyPageNotifierStateCopyWithImpl;
  @override
  @useResult
  $Res call({Page page, AsyncValue<void>? likeOr});
