...
final _onlineCountsProvider = _OnlineCountsProvider._();

final class _OnlineCountsProvider
    extends $FunctionalProvider<AsyncValue<int>, int, FutureOr<int>>
    with $FutureModifier<int>, $FutureProvider<int> {
  _OnlineCountsProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
...
final _totalMemoriesProvider = _TotalMemoriesProvider._();

final class _TotalMemoriesProvider
    extends $FunctionalProvider<AsyncValue<int>, int, FutureOr<int>>
    with $FutureModifier<int>, $FutureProvider<int> {
  _TotalMemoriesProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
...
@ProviderFor(_ping)
final _pingProvider = _PingProvider._();
