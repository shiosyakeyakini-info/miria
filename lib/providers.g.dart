...
const lookupRepositoryProvider = LookupRepositoryFamily._();
...
final class LookupRepositoryProvider
  ...
  const LookupRepositoryProvider._({
    required LookupRepositoryFamily super.from,
    required Account super.argument,
  }) : super(
         retry: null,
  ...
  @override
  String toString() {
    return r'lookupRepositoryProvider'
        ''
        '($argument)';
  }
  ...
  LookupRepository create(Ref ref) {
    final argument = this.argument as Account;
    return lookupRepository(ref, argument);
  }
  ...
  @override
  bool operator ==(Object other) {
    return other is LookupRepositoryProvider && other.argument == argument;
  }
...
String _$lookupRepositoryHash() => r'c5dd8a3647a55c821a38877ebf4f5a517b5f5508';

final class LookupRepositoryFamily extends $Family
    with $FunctionalFamilyOverride<LookupRepository, Account> {
  const LookupRepositoryFamily._()
    : super(
        retry: null,
        name: r'lookupRepositoryProvider',
        dependencies: null,
  ...
  LookupRepositoryProvider call(Account account) =>
      LookupRepositoryProvider._(argument: account, from: this);

  @override
  String toString() => r'lookupRepositoryProvider';
}
