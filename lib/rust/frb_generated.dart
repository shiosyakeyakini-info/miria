...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<DecodedImage?> crateApiImageCodecDecodeJpegXl({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiImageCodecDecodeJpegXlConstMeta,
        argValues: [bytes],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiImageCodecDecodeJpegXlConstMeta =>
  ...
  DecodedImage dco_decode_box_autoadd_decoded_image(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_decoded_image(raw);
  }
  ...
  DecodedImage? dco_decode_opt_box_autoadd_decoded_image(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_decoded_image(raw);
  }
  ...
  DecodedImage sse_decode_box_autoadd_decoded_image(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_decoded_image(deserializer));
  }
  ...
  DecodedImage sse_decode_decoded_image(SseDeserializer deserializer) {
    ...
    return DecodedImage(width: var_width, height: var_height, rgba: var_rgba);
  }
  ...
  DecodedImage? sse_decode_opt_box_autoadd_decoded_image(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_decoded_image(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_box_autoadd_decoded_image(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_decoded_image(self, serializer);
  }
  ...
  void sse_encode_opt_box_autoadd_decoded_image(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_decoded_image(self, serializer);
    }
  }
