...
final class UsersListsNotifierProvider
  ...
  @$internal
  @override
  $AsyncNotifierProviderElement<UsersListsNotifier, List<UsersList>>
...
abstract class _$UsersListsNotifier extends $AsyncNotifier<List<UsersList>> {
  ...
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<AsyncValue<List<UsersList>>>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<AsyncValue<List<UsersList>>>,
