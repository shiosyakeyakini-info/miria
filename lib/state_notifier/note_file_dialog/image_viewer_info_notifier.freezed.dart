...
mixin _$ImageViewerInfo {
  ...
  $ImageViewerInfoCopyWith<ImageViewerInfo> get copyWith =>
      _$ImageViewerInfoCopyWithImpl<ImageViewerInfo>(
          this as ImageViewerInfo, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ImageViewerInfo &&
...
abstract mixin class $ImageViewerInfoCopyWith<$Res> {
  factory $ImageViewerInfoCopyWith(
          ImageViewerInfo value, $Res Function(ImageViewerInfo) _then) =
      _$ImageViewerInfoCopyWithImpl;
  @useResult
  $Res call(
      {double scale,
      double lastScale,
...
class _ImageViewerInfo implements ImageViewerInfo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ImageViewerInfoCopyWith<_ImageViewerInfo> get copyWith =>
      __$ImageViewerInfoCopyWithImpl<_ImageViewerInfo>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ImageViewerInfo &&
            (identical(other.scale, scale) || other.scale == scale) &&
            (identical(other.lastScale, lastScale) ||
                other.lastScale == lastScale) &&
            (identical(other.pointersCount, pointersCount) ||
...
/// @nodoc
abstract mixin class _$ImageViewerInfoCopyWith<$Res>
    implements $ImageViewerInfoCopyWith<$Res> {
  factory _$ImageViewerInfoCopyWith(
          _ImageViewerInfo value, $Res Function(_ImageViewerInfo) _then) =
      __$ImageViewerInfoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double scale,
