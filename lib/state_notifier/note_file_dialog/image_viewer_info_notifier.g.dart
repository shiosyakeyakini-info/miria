...
final class ImageViewerInfoNotifierProvider
  ...
  @$internal
  @override
  $NotifierProviderElement<ImageViewerInfoNotifier, ImageViewerInfo>
  ...
  Override overrideWithValue(ImageViewerInfo value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<ImageViewerInfo>(value),
    );
  }
}
...
abstract class _$ImageViewerInfoNotifier extends $Notifier<ImageViewerInfo> {
  ...
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<ImageViewerInfo>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<ImageViewerInfo>,
              ImageViewerInfo,
              Object?,
              Object?
            >;
