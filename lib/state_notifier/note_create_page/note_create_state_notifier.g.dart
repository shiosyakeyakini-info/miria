...
final class NoteCreateNotifierProvider
  ...
  @$internal
  @override
  $NotifierProviderElement<NoteCreateNotifier, NoteCreate> $createElement(
  ...
  Override overrideWithValue(NoteCreate value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<NoteCreate>(value),
    );
  }
}
...
abstract class _$NoteCreateNotifier extends $Notifier<NoteCreate> {
  ...
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<NoteCreate>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<NoteCreate>,
              NoteCreate,
              Object?,
              Object?
            >;
