...
mixin _$FederationData {
  ...
  String? get impressumUrl => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $FederationDataCopyWith<$Res> {
  factory $FederationDataCopyWith(
          FederationData value, $Res Function(FederationData) then) =
...
/// @nodoc
class _$FederationDataCopyWithImpl<$Res, $Val extends FederationData>
    implements $FederationDataCopyWith<$Res> {
  _$FederationDataCopyWithImpl(this._value, this._then);
...
abstract class _FederationData implements FederationData {
  const factory _FederationData(
      ...
      final MetaResponse? meta}) = _$_FederationData;
