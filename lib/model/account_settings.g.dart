...
Map<String, dynamic> _$AccountSettingsToJson(
  _AccountSettings instance,
) => <String, dynamic>{
  ...
  'emojiCacheStrategy': _$CacheStrategyEnumMap[instance.emojiCacheStrategy]!,
  'latestEmojiCached': instance.latestEmojiCached?.toIso8601String(),
  'metaChacheStrategy': _$CacheStrategyEnumMap[instance.metaChacheStrategy]!,
