...
mixin _$SummalyResult {
  ...
  $SummalyResultCopyWith<SummalyResult> get copyWith =>
      _$SummalyResultCopyWithImpl<SummalyResult>(
          this as SummalyResult, _$identity);
...
abstract mixin class $SummalyResultCopyWith<$Res> {
  factory $SummalyResultCopyWith(
          SummalyResult value, $Res Function(SummalyResult) _then) =
      _$SummalyResultCopyWithImpl;
  @useResult
  $Res call(
      {Player player,
      String? title,
...
class _SummalyResult implements SummalyResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SummalyResultCopyWith<_SummalyResult> get copyWith =>
      __$SummalyResultCopyWithImpl<_SummalyResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SummalyResultToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SummalyResultCopyWith<$Res>
    implements $SummalyResultCopyWith<$Res> {
  factory _$SummalyResultCopyWith(
          _SummalyResult value, $Res Function(_SummalyResult) _then) =
      __$SummalyResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {Player player,
...
class _Player implements Player {
  const _Player({this.url, this.width, this.height, final List<String>? allow})
      : _allow = allow;
