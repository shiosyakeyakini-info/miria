...
mixin _$AccountSettings {
  ...
  List<String> get mutedReactions;
  ...
  $AccountSettingsCopyWith<AccountSettings> get copyWith =>
      _$AccountSettingsCopyWithImpl<AccountSettings>(
          this as AccountSettings, _$identity);
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.mutedReactions, mutedReactions) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(mutedReactions),
...
abstract mixin class $AccountSettingsCopyWith<$Res> {
  factory $AccountSettingsCopyWith(
          AccountSettings value, $Res Function(AccountSettings) _then) =
      _$AccountSettingsCopyWithImpl;
  @useResult
  $Res call(
      {String userId,
      String host,
      List<String> reactions,
      List<String> mutedReactions,
...
class _AccountSettings extends AccountSettings {
  const _AccountSettings(
      ...
      final List<String> mutedReactions = const [],
      ...
      : _reactions = reactions,
        _mutedReactions = mutedReactions,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AccountSettingsCopyWith<_AccountSettings> get copyWith =>
      __$AccountSettingsCopyWithImpl<_AccountSettings>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AccountSettingsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AccountSettings &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.host, host) || other.host == host) &&
            const DeepCollectionEquality()
                .equals(other._reactions, _reactions) &&
            const DeepCollectionEquality()
                .equals(other._mutedReactions, _mutedReactions) &&
            (identical(other.defaultNoteVisibility, defaultNoteVisibility) ||
                other.defaultNoteVisibility == defaultNoteVisibility) &&
            (identical(other.defaultIsLocalOnly, defaultIsLocalOnly) ||
                other.defaultIsLocalOnly == defaultIsLocalOnly) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_mutedReactions),
      defaultNoteVisibility,
      defaultIsLocalOnly,
      defaultReactionAcceptance,
      iCacheStrategy,
...
/// @nodoc
abstract mixin class _$AccountSettingsCopyWith<$Res>
    implements $AccountSettingsCopyWith<$Res> {
  factory _$AccountSettingsCopyWith(
          _AccountSettings value, $Res Function(_AccountSettings) _then) =
