...
mixin _$ClipSettings {
  ...
  $ClipSettingsCopyWith<ClipSettings> get copyWith =>
      _$ClipSettingsCopyWithImpl<ClipSettings>(
          this as ClipSettings, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ClipSettings &&
...
abstract mixin class $ClipSettingsCopyWith<$Res> {
  factory $ClipSettingsCopyWith(
          ClipSettings value, $Res Function(ClipSettings) _then) =
      _$ClipSettingsCopyWithImpl;
  @useResult
  $Res call({String name, String? description, bool isPublic});
}

/// @nodoc
class _$ClipSettingsCopyWithImpl<$Res> implements $ClipSettingsCopyWith<$Res> {
...
class _ClipSettings extends ClipSettings {
  const _ClipSettings({this.name = "", this.description, this.isPublic = false})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ClipSettingsCopyWith<_ClipSettings> get copyWith =>
      __$ClipSettingsCopyWithImpl<_ClipSettings>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ClipSettings &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
            (identical(other.isPublic, isPublic) ||
...
/// @nodoc
abstract mixin class _$ClipSettingsCopyWith<$Res>
    implements $ClipSettingsCopyWith<$Res> {
  factory _$ClipSettingsCopyWith(
          _ClipSettings value, $Res Function(_ClipSettings) _then) =
      __$ClipSettingsCopyWithImpl;
  @override
  @useResult
  $Res call({String name, String? description, bool isPublic});
}
