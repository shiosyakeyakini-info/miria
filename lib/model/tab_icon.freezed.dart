...
mixin _$TabIcon {
  ...
  $TabIconCopyWith<TabIcon> get copyWith =>
      _$TabIconCopyWithImpl<TabIcon>(this as TabIcon, _$identity);
...
abstract mixin class $TabIconCopyWith<$Res> {
  factory $TabIconCopyWith(TabIcon value, $Res Function(TabIcon) _then) =
      _$TabIconCopyWithImpl;
  @useResult
  $Res call({int? codePoint, String? customEmojiName});
}

/// @nodoc
class _$TabIconCopyWithImpl<$Res> implements $TabIconCopyWith<$Res> {
...
class _TabIcon implements TabIcon {
  ...
  factory _TabIcon.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TabIconCopyWith<_TabIcon> get copyWith =>
      __$TabIconCopyWithImpl<_TabIcon>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TabIconToJson(
      this,
    );
  }
...
abstract mixin class _$TabIconCopyWith<$Res> implements $TabIconCopyWith<$Res> {
  factory _$TabIconCopyWith(_TabIcon value, $Res Function(_TabIcon) _then) =
      __$TabIconCopyWithImpl;
  @override
  @useResult
  $Res call({int? codePoint, String? customEmojiName});
}
...
/// @nodoc
class __$TabIconCopyWithImpl<$Res> implements _$TabIconCopyWith<$Res> {
