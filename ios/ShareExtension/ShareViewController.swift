...
class ShareViewController: UIViewController, FlutterPluginRegistry {
    ...
    func showFlutter() {
        //self.preferredContentSize = CGSize(width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.height * 0.8)
        self.view.frame = CGRect(x: 0, y: 0, width:UIScreen.main.bounds.size.width, height:UIScreen.main.bounds.size.height * 0.8)
...
//        let hostAppBundleIdentifier = "info.shiosyakeyakini.miria"
...
//                    this.sharedText.removeAll()
//                    if(title != nil) {
//                        this.sharedText.append("[\(title ?? "")](\(item.absoluteString))")
//                    } else {
